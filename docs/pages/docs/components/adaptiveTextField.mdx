...
import { AdaptiveSelectItem } from "adaptive-material-ui/components/select/adaptiveSelect";
import { AdaptiveTextField } from "adaptive-material-ui/components/textField/adaptiveTextField";
    ...
    <AdaptiveModeDemo adaptiveMode="ios">
      <DemoList>
        ...
        <DemoListItem title="Error">
          <AdaptiveTextField error label="Standard" variant="standard" />
          <AdaptiveTextField error label="Outlined" variant="outlined" />
          <AdaptiveTextField error label="Filled" variant="filled" />
        </DemoListItem>
...
- `slotProps.inputLabel.focused` defaults to `false` on iOS

<AdaptiveModeApi />

### AdaptiveInput

[MUI Input API](https://mui.com/material-ui/api/input/) with a `adaptiveMode` prop

### AdaptiveFilledInput

[MUI Filled Input API](https://mui.com/material-ui/api/filled-input/) with a `adaptiveMode` prop

### AdaptiveOutlinedInput

[MUI Outlined Input API](https://mui.com/material-ui/api/outlined-input/) with a `adaptiveMode` prop
