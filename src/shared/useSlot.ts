...
import mergeSlotProps, { WithCommonProps } from "@mui/utils/mergeSlotProps";
...
// https://github.com/mui/material-ui/blob/v7.3.6/packages/mui-material/src/utils/useSlot.ts
